...
```{r, echo=FALSE,out.width="100%",fig.cap="Chatgpt refusal to answer",fig.show='hold'}
knitr::include_graphics("images/Tutorial_1.png")
```

However, you can be more specific and avoid certain words that Chatgpt may find offensive

```{r, echo=FALSE,out.width="100%",fig.cap="Chatgpt answer to a different prompt ",fig.show='hold'}
knitr::include_graphics("images/Tutorial_2.png")
```

You can ask Chatgpt to write in a specific format , tone , or delimited parameters. 

```{r, echo=FALSE,out.width="100%",fig.cap=" Poem by Chatgpt ",fig.show='hold'}
knitr::include_graphics("images/Tutorial_3.png")
```

Rap song in the tone of Drake about artificial intelligence. 

```{r, echo=FALSE,out.width="100%",fig.cap="Chatgpt answer to a different prompt ",fig.show='hold'}
knitr::include_graphics("images/Tutorial_4.png")
```
...
```{r, echo=FALSE,out.width="100%",fig.cap="Claude interface",fig.show='hold'}
knitr::include_graphics("images/Tutorial_B_1.png")
```
...
```{r, echo=FALSE,out.width="100%",fig.cap="Claude example",fig.show='hold'}
knitr::include_graphics("images/Tutorial_B_2.png")
```
...
```{r, echo=FALSE,out.width="100%",fig.cap="Claude example",fig.show='hold'}
knitr::include_graphics("images/Tutorial_C_1.png")
```

A better example with links to find the sources

```{r, echo=FALSE,out.width="100%",fig.cap="Claude example",fig.show='hold'}
knitr::include_graphics("images/Tutorial_C_2.png")
```
...
```{r, echo=FALSE,out.width="100%",fig.cap="Dalle 3 interface ",fig.show='hold'}
knitr::include_graphics("images/Tutorial_D_1.png")
```

It will output various versions and you can choose. 

```{r, echo=FALSE,out.width="100%",fig.cap="Dalle-3 Halloween pig",fig.show='hold'}
knitr::include_graphics("images/Tutorial_D_2.png")
```
...
```{r, echo=FALSE,out.width="100%",fig.cap=" Llama V2 ",fig.show='hold'}
knitr::include_graphics("images/llama.png")
```
...
```{r, echo=FALSE,out.width="100%",fig.cap="Connected papers example",fig.show='hold'}
knitr::include_graphics("images/Connected_papers.png")
```
...
```{r, echo=FALSE,out.width="100%",fig.cap="Evidence hunt test with coffee research",fig.show='hold'}
knitr::include_graphics("images/evidence_hunt.png")
```
...
```{r, echo=FALSE,out.width="100%",fig.cap="Consesus interface",fig.show='hold'}
knitr::include_graphics("images/Consesus_1.png")
```
...
```{r, echo=FALSE,out.width="100%",fig.cap="Consesus test with coffee",fig.show='hold'}
knitr::include_graphics("images/Consensus_2.png")
```
...
```{r, echo=FALSE,out.width="100%",fig.cap="Sourcely ai",fig.show='hold'}
knitr::include_graphics("images/Sourcely_ai.png")
```
